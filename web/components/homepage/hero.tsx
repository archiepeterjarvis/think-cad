    ...
    <section className="py-20 md:py-32 relative overflow-hidden">
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center rounded-full border border-primary/20 bg-primary/5 px-4 py-2 text-sm mb-8">
          ...
          <div className="gradient-border p-8 shadow-lg bg-white/80 backdrop-blur-sm">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="text-left">
                <h3 className="font-semibold mb-2 flex items-center">
                  <span className="w-6 h-6 rounded-full bg-accent/10 text-accent flex items-center justify-center text-xs mr-2">
                    2
                  </span>
                  Output:
                </h3>
                <div className="bg-gradient-to-br from-primary/5 to-purple/5 p-6 rounded-lg flex items-center justify-center h-32 relative">
      ...
      {/* Decorative elements */}
      <div className="absolute top-1/4 left-10 w-24 h-24 border-2 border-dashed border-primary/20 rounded-lg rotate-12 opacity-70"></div>
      <div className="absolute bottom-1/4 right-10 w-32 h-32 border-2 border-dashed border-purple/20 rounded-full opacity-70"></div>
    </section>
  );
}
