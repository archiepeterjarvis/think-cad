...
class SpacyNERModel:
    ...
    def predict(self, prompt: str, confidence_threshold: float = 0.5) -> list[dict]:
        """
        Predict named entities in the given prompt using the loaded SpaCy model.

        Args:
            prompt: The prompt to extract entities from.
            confidence_threshold: The minimum confidence score for entities to be included in the results.
